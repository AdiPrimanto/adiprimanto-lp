    ...
    >
      ...
      >
        ...
        <div className="section-eyebrow">
          06 <span className="eyebrow-sep">/</span> TESTIMONI KLIEN
        </div>
        ...
        <div className="mb-12">
          ...
          >
            Bukti Nyata <span className="gradient-text">Kepuasan Klien.</span>
          </h2>
          <p
            className="text-sm font-light max-w-lg leading-[1.8]"
            style={{ color: "var(--color-muted)" }}
          >
            Tangkapan layar asli dari percakapan WhatsApp bersama klien yang
            telah mempercayakan proyek website dan aplikasi mereka kepada saya.
          </p>
        </div>
              ...
              <div className="flex gap-2">
                {testimonials.map((_, i) => (
                  <button
                    ...
                    aria-label={`Buka halaman testimoni ${i + 1}`}
                  />
                ))}
              </div>
            </div>
