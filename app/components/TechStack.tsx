      ...
      >
        ...
        >
          <div className="section-eyebrow">
            03 <span className="eyebrow-sep">/</span> TECH STACK
          </div>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-14">
            ...
            >
              Tools yang Saya <span className="gradient-text">Kuasai.</span>
            </h2>
            <p
              className="text-sm font-light max-w-xs md:text-right"
              style={{ color: "var(--color-muted)" }}
            >
              Stack yang dipilih untuk performa, skalabilitas, dan hasil terbaik
              bagi klien.
            </p>
          </div>
        </motion.div>
