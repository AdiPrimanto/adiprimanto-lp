...
const Footer = () => (
  ...
  >
    ...
    <div
      ...
      style={{
        background:
          "linear-gradient(90deg, transparent 0%, rgba(43,127,255,0.3) 30%, rgba(0,212,255,0.3) 70%, transparent 100%)",
      }}
    />
      ...
      <div className="grid md:grid-cols-[1.4fr_1fr_1.2fr] gap-10 max-md:grid-cols-1">
        ...
        <div className="flex flex-col gap-4">
          ...
          <a
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = "rgba(43, 127, 255, 0.15)";
            ...
            onMouseLeave={(e) => {
              ...
              e.currentTarget.style.borderColor = "rgba(43, 127, 255, 0.2)";
    ...
    >
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        >
          ...
          {new Date().getFullYear()} Adi Primanto. All Rights Reserved.
        </p>
        <a
          href="#home"
