...
import { Code2, Coffee, Rocket, MapPin, Briefcase, Calendar } from 'lucide-react';
...
const funFacts = [
  ...
  { icon: <Rocket size={18} />, text: 'Selalu mikir: “gimana caranya website ini bantu bisnis?”' },
];
...
const About = () => (
  <section id="about" className="py-24 relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      >
        <span className="text-blue-500 font-semibold text-sm tracking-wider uppercase">Tentang Saya</span>
        <h2 className="text-4xl md:text-5xl font-bold text-white mt-2">Orang di Balik Layar</h2>
      </motion.div>
        ...
        >
          ...
          <div className="relative max-w-md mx-auto lg:mx-0">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-br from-gray-800 to-gray-900 aspect-[4/5]">
              ...
              <img src="/adi.webp" alt="Adi Primanto" className="w-full h-full object-cover" />
            </div>
            ...
            <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-gray-900 border border-white/10 px-4 py-2 rounded-full flex items-center gap-2 shadow-xl">
              ...
              <span className="text-white text-sm font-medium">Yogyakarta, Indonesia</span>
            </div>
          </div>
        ...
        >
          <div>
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              Halo! Saya <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-700">Adi Primanto</span>
            </h3>
            <p className="text-gray-300 leading-relaxed text-lg">
              Seorang <strong className="text-white">Frontend Engineer</strong> dengan pengalaman lebih dari <strong className="text-blue-400">5 tahun</strong> membangun website dan aplikasi web yang tidak hanya cantik, tapi juga fungsional dan performant.
            </p>
          </div>

          <p className="text-gray-400 leading-relaxed">
            Saat ini bekerja di salah satu startup di Yogyakarta, saya terbiasa menghadapi tantangan membangun produk digital dari nol hingga digunakan ribuan pengguna. Pengalaman ini mengajarkan saya pentingnya kode yang bersih, performa yang optimal, dan user experience yang seamless.
          </p>

          <p className="text-gray-400 leading-relaxed">
            Di luar jam kerja, saya menyalurkan passion saya untuk membantu UMKM dan bisnis lokal hadir secara profesional di dunia digital melalui website yang didesain khusus untuk kebutuhan mereka.
          </p>

          {/* Tech Stack */}
          <div className="pt-4">
            <h4 className="text-white font-semibold mb-4">Tech Stack Favorit:</h4>
